...
extension FinancialColors on ColorScheme {
  ...
  Color get oweColor => brightness == Brightness.light ? const Color(0xFFDC2626) : const Color(0xFFF87171);

  /// Color indicating that someone owes the current user money (green, contrast > 4.5:1).
  Color get owedColor => brightness == Brightness.light ? const Color(0xFF15803D) : const Color(0xFF34D399);
}
